    ...
    <div class="card border-0">
        <div class="card-body">
            <form action="{{ route('admin.products.store') }}" method="POST">
                ...
                <x-form.select2-input :label="trans('cruds.product.fields.category')" :helper="trans('cruds.product.fields.category_helper')" name="category_id" :options="$categories" placeholder="None" required/>
                ...
                <x-form.select2-input :label="trans('cruds.product.fields.quality')" :helper="trans('cruds.product.fields.quality_helper')" name="quality" :options="\App\Models\Product::QUALITY" required/>
